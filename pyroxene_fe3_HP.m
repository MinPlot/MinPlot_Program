...
if strcmp(wantstrctfrm, 'y')
    ...
    if strcmp(wantplots, 'y')
        ...
        StrctFrm=array2table(all,'VariableNames',{'Si_T','Al_T','Fe3_T','Sum_T','Si_M1','Al_M1','Ti_M1','Cr_M1','Fe3_M1','Mn_M1','Mg_M1','Fe2_M1','Sum_M1','Mg_M2','Fe2_M2','Ca_M2','Na_M2','K_M2','Sum_M2','Xjd','Xaeg','Xdi+hd','Xcats','Xkos','XK_kos','XK_jd','XTi_cpx','Xcaes','Xen','O2_deficiency'});
