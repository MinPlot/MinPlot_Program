...
if strcmp(wantstrctfrm, 'y')
    ...
    if strcmp(wantplots, 'y')
        ...
        Fe3=StrctFrm(:,8)./(StrctFrm(:,8)+StrctFrm(:,7)+StrctFrm(:,5));
        Cr=StrctFrm(:,7)./(StrctFrm(:,8)+StrctFrm(:,7)+StrctFrm(:,5));
        Al=StrctFrm(:,5)./(StrctFrm(:,8)+StrctFrm(:,7)+StrctFrm(:,5));
...
StrctFrm=array2table(all,'VariableNames',{'Si_T','Al_T','Fe3_T','Sum_T','Al_Oct','Ti_Oct','Cr_Oct','Fe3_Oct','Sum_Oct','Y_Dod','Fe2_Dod','Mn_Dod','Mg_Dod','Ca_Dod','Na_Dod','Sum_Dod','Xalm','Xprp','Xsps','Xgrs','Xadr','Xuv','O2_deficiency'});
