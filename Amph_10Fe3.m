function APFU=Amph_10Fe3(APFU_Fe,O2_Ti)

%Normalize to (46 - Si - Al - Ti - Cr)

[m,n]=size(APFU_Fe); %finds the x and y size of the input data matrix

Cat=APFU_Fe(:,1:11);

Norm(:,1)=36./(46-sum(Cat(:,1:4),2)); %Normalize to 16 cations
...
APFU(:,18)=36./(46-sum(APFU(:,1:4),2)); %Criteria 2-4: tetrahedral sites completely filled by 3+ and 4+ cations
